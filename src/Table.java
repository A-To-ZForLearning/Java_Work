...
public final class Table {
    ...
    public Table(Board board, int tableWidth, List<String> headersList, List<ArrayList<String>> rowsList2) {
        this.board = board;
        if (tableWidth <= 0) {
        ...
        List<String> firstRow = rowsList2.get(0);
    ...
    public Table(Board board, int tableWidth, List<String> headersList, List<ArrayList<String>> rowsList, List<Integer> colWidthsList) {
    ...
    public Table(Board board, int tableWidth, List<String> headersList, List<ArrayList<String>> rowsList, List<Integer> colWidthsList, List<Integer> colAlignsList) {
    ...
    public Table setRowsList(List<ArrayList<String>> rowsList) {
